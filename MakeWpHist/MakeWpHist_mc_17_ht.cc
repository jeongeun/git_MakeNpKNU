   ...
   int MKinCutPass        = 0 ; 
     ...
     for(int eventLoop=0; eventLoop<TotalN ; eventLoop++) {
        ...
        for(int i=0; i<genParticleTCA->GetEntries(); i++){
            npknu::GenParticle* genPtr = (npknu::GenParticle*)genParticleTCA->At(i);
             //  cout << "status " << genPtr->status << " pdgId " << genPtr->pdgId << " pt " << genPtr->pt << endl; 
            if(genPtr->status == 23 and (std::abs(genPtr->pdgId) < 6 || std::abs(genPtr->pdgId) == 21) ) {
               //cout << "HT  status " << genPtr->status << " pdgId " << genPtr->pdgId << " pt " << genPtr->pt << endl; 
               ht += genPtr->jetPt;
            }
        ...
        NGenMasscut++;
        if((type == 9   ) && (ht > 300.0 )               ) continue ; //WJetsToLNu cut above M(W)>100GeV
        if((type == 92  ) && (ht < 300.0  || ht > 400.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
        ...
        isMETBadPFMuon = ( /*metPtr->filterbadPFMuon == 0 ||*/ metPtr->IsNoBadPFMuon == 0) ;
        if (isMETBadPFMuon) NBadPFMu ++; //Count BadMET

        isMETBadChMuon = ( /*metPtr->filterbadChCandidate == 0 ||*/  metPtr->IsNoBadChargedCandidate == 0 ) ;
	 ...
	 hwgen_HT->Write();
        ...
        cout << "## IsBF ? " << IsBF <<  " " << fileName
             ...
             << " hgen_HT Integral = "  << hwgen_HT->Integral()
        ...
        cout << "@Num of TotEvent      = " << setw(12) << TotalN             << " : " << 100 * double(TotalN )/double(TotalN )    <<  endl ;
        ...
        cout << " BadNum of BadMet     = " << setw(12) << Nmetfil            << " : " << 100 * double(Nmetfil  )/double(TotalN )  << " % Filtered in tot" << endl ;
        cout << " BadNum of BadPFMu    = " << setw(12) << NBadPFMu           << " : " << 100 * double(NBadPFMu )/double(TotalN )  << " % Filtered in tot" << endl ;
        cout << " BadNum of BadChCan   = " << setw(12) << NnoBadch           << " : " << 100 * double(NnoBadch )/double(TotalN )  << " % Filtered in tot" << endl ;
        cout << "@Num of passGoodMET   = " << setw(12) << NpassMET           << " : " << 100 * double(NpassMET)/double(TotalN )   << " % Survived in tot" << endl ;
        cout << "@Num of Mupt>53       = " << setw(12) << Nmupt50            << " : " << 100 * double(Nmupt50 )/double(TotalN )   << " % Survived in tot" << endl ;
        cout << "@Num of HLT           = " << setw(12) << Ntrigg             << " : " << 100 * double(Ntrigg  )/double(TotalN )   << " % Survived in tot" << endl ;
        cout << "@Num of HighPtExist   = " << setw(12) << NHighPtExist       << " : " << 100 * double(NHighPtExist   )/double(TotalN) << " % Survived in tot" << endl ;
        cout << " Num of HighPt1PassTrk= " << setw(12) << NHighPtPassTrk     << " : " << 100 * double(NHighPtPassTrk )/double(TotalN) << " % Survived in tot" << endl ;
        cout << " Num of HighPt2       = " << setw(12) << NHighPt2           << " : " << 100 * double(NHighPt2)/double(TotalN)        << " % Exist in tot" << endl ;
        cout << " BadNum of HighPt2Big = " << setw(12) << NHighPt2ButBig     << " : " << 100 * double(NHighPt2ButBig)/double(NHighPt2)<< " % Exist in HighPt2" << endl ;
        cout << " BadNum of Close dR03 = " << setw(12) << NCloseR            << " : " << 100 * double(NCloseR)/double(NHighPt2ButBig) << " % Exist in HighPt2ButBig" << endl ;
        cout << " Num of SoftMuPass25  = " << setw(12) << NSoftMuPassVeto25  << " : " << 100 * double(NSoftMuPassVeto25)/double(NHighPtPassTrk) << " % Passed in HighPtExist" << endl ;
        cout << " Num of HighPt2Pass25 = " << setw(12) << NHighPt2PassVeto25 << " : " << 100 * double(NHighPt2PassVeto25)/double(NHighPt2)      << " % Passed in HighPt2" << endl;
        cout << "@Num of Muon Selection= " << setw(12) << NMuonSelection     << " : " << 100 * double(NMuonSelection)/double(TotalN)  << " % Survived in tot" << endl ;
        cout << " Num of Mt>60GeV      = " << setw(12) << NMt60Cut           << " : " << 100 * double(NMt60Cut)/double(TotalN)        << " % Survived in tot" << endl ;
        cout << "@Num of Mt>80 KinCut  = " << setw(12) << MKinCutPass        << " : " << 100 * double(MKinCutPass)/double(TotalN)     << " % Survived in tot" << endl ;
