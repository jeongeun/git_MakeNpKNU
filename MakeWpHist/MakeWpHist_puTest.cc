...
//
//     hgen_WM  = new TH1F("hgen_WM", "hgen_WM",500,0,5000);   
//     hgen_Wpt = new TH1F("hgen_Wpt","hgen_Wpt",500,0,5000);  
//     hwgen_WM  = new TH1F("hwgen_WM", "Weighted hgen_WM",500,0,5000);      hgen_WM ->Sumw2(); 
//     hwgen_Wpt = new TH1F("hwgen_Wpt","Weighted hgen_Wpt",500,0,5000);     hgen_Wpt->Sumw2(); 
...
//     }
     for(int p=0; p<10; p++){ //Draw Variables
        hetc_ori[p] = new TH1F(etcstr_ori[p],etcstr_ori[p], etcbin[p], etcxmin[p], etcxmax[p]); 
        hetc_ori[p]->GetXaxis()->SetTitle(etcxTitle[p]);  
        hetc_ori[p]->Sumw2();
...
//   int MKinCutPass        = 0 ; 
     ...
     for(int eventLoop=0; eventLoop<1000 ; eventLoop++) {
        ...
        cout << " " << eventLoop << " TruePU=" << pileup << " puWeight=" << pileupWeight << " | " ;
     ...
     //       //if(TMath::Abs(genPtr->pdgId) == 24) cout << "genPtr->pdgId" << genPtr->pdgId << " status " << genPtr->status << " mass " << genPtr->mass << " pt " << genPtr->pt << endl;
     //       //if((type == 100 ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass < 100.0 || genPtr->mass > 200.0)  ) continue ;
     //       //if((type == 200 ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass < 200.0 || genPtr->mass > 500.0)  ) continue ;
     //       //if((type == 500 ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass < 500.0 || genPtr->mass > 1000.0) ) continue ;
     //       //if((type == 1000) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass < 1000.0 || genPtr->mass > 2000.0)) continue ;
     //       //if((type == 2000) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass < 2000.0 || genPtr->mass > 3000.0)) continue ;
     //       //if((type == 3000) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass < 3000.0)) continue;
     //       //if((type == 9   ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass > 100.0) && (genPtr->pt > 300.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
     //       //if((type == 92  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass > 100.0) && (genPtr->pt < 300.0 || genPtr->pt >400.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
     //       //if((type == 94  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass > 100.0) && (genPtr->pt < 400.0 || genPtr->pt >600.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
     //       //if((type == 96  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass > 100.0) && (genPtr->pt < 600.0 || genPtr->pt >800.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
     //       //if((type == 98  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass > 100.0) && (genPtr->pt < 800.0 || genPtr->pt >1200.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
     //       //if((type == 912 ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass > 100.0) && (genPtr->pt < 1200.0 || genPtr->pt >2500.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
     //       //if((type == 925 ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 62) && (genPtr->mass > 100.0) && (genPtr->pt < 2500.0 )) continue ; //WJetsToLNu cut above M(W)>100GeV
     ...
     //       if((type == 3000) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass > 3000.0)) IsW3000 = true ;

     //       if((type == 9   ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass < 100.0) && (genPtr->pt < 300.0 )) IsWJet = true ; //WJetsToLNu cut above M(W)>100GeV
     //       if((type == 92  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass < 100.0) && (genPtr->pt > 300.0 &&  genPtr->pt <400.0 )) IsWJet2  = true; //WJetsToLNu cut above M(W)>100GeV
     //       if((type == 94  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass < 100.0) && (genPtr->pt > 400.0 &&  genPtr->pt <600.0 ))  IsWJet4 = true; //WJetsToLNu cut above M(W)>100GeV
     //       if((type == 96  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass < 100.0) && (genPtr->pt > 600.0 &&  genPtr->pt <800.0 ))  IsWJet6 = true; //WJetsToLNu cut above M(W)>100GeV
     //       if((type == 98  ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass < 100.0) && (genPtr->pt > 800.0 &&  genPtr->pt <1200.0 )) IsWJet8 = true; //WJetsToLNu cut above M(W)>100GeV
     //       if((type == 912 ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass < 100.0) && (genPtr->pt > 1200.0 && genPtr->pt <2500.0 )) IsWJet12= true; //WJetsToLNu cut above M(W)>100GeV
     //       if((type == 925 ) && (TMath::Abs(genPtr->pdgId) == 24) && (genPtr->status == 22) && (genPtr->mass < 100.0) && (genPtr->pt > 2500.0 )) IsWJet25= true ; //WJetsToLNu cut above M(W)>100GeV
     //      
     //       if(IsW100  ||IsW200  ||IsW500  ||IsW1000  ||IsW2000  ||IsW3000  ||IsWJet  ||IsWJet2  ||IsWJet4  ||IsWJet6  ||IsWJet8  ||IsWJet12  ||IsWJet25){
     //           IsGenPass = true; 
     //           cout << "NGencut = " << NGencut << " IsGenPass " << IsGenPass << ": Type " << type << " WMass " << genPtr->mass << " Wpt " << genPtr->pt << endl;
     //           NGencut++; 
     //           hgen_WM->Fill(genPtr->mass); 
     //           hwgen_WM->Fill(genPtr->mass,tWeight); 
     //           hgen_Wpt->Fill(genPtr->pt);  
     //           hwgen_Wpt->Fill(genPtr->pt ,tWeight); 
     //        }
     //   }
     //   if(!IsGenPass) continue;
     //   NGenMasscut++;
	...
	// hwgen_WM->Write();
        ...
        //cout << "## RunGH" << fileName
        //     << " hgen_WM Integral = "  << hwgen_WM->Integral()
        //     << " hgen_Wpt Integral = " << hwgen_Wpt->Integral()
