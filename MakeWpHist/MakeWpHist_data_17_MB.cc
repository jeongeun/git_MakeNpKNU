...
/*     TClonesArray* photonTCA      = new TClonesArray("npknu::Photon")         ;       inChain->SetBranchAddress("photon"       , &photonTCA      ); */
   ...
   int MKinCutPass        = 0 ; 
     ...
     for(int eventLoop=0; eventLoop<TotalN ; eventLoop++) {
        ...
        bool isMuPreselection = npknu::GetMuonPreselection(muonTCA, 900.0, 0.0, 2.4); /*highPtMuonGVId, ptCut, etaCut*/
       ...
       bool noSoftbiggermuon = true ;
        ...
        double dR = 0.0 ;
        npknu::GetMuonIdTCA(muonTCA, muIdTCA, 6, 900.0, 0.0, 1.2); /*highPtMuonGVId, ptCut, etaCut*/
	...
	for(int i=0; i< muonTCA->GetEntries(); i++){
       ...
       NMuonSelection++;
        ...
        if(highmuPtr0->GetMt(metPtr) < 1700.0) continue;
        ...
        cout << "Run:lumi:evt " << evtPtr->run << ":" << evtPtr->lumi <<":" << evtPtr->event << " nVtx " << nVtx << " Mt=" << highmuPtr0->GetMt(metPtr) << " muPt=" <<highmuPtr0->pt << " muEta=" << highmuPtr0->eta ;
        cout << " muPhi=" << highmuPtr0->phi << " met=" << metPtr->pt  << " uncorr=" << metPtr->Uncorr_pt << " metPhi=" << metPtr->phi << " dphi=" << highmuPtr0->deltaPhi(metPtr)<< " etratio=" << highmuPtr0->etRatio(metPtr)<< endl;
        ...
        cout << "## Muon Barrel 0 < |eta| < 1.2" << fileName
        ...
        cout << "@Num of Mupt53        = " << setw(12) << Nmupt50            << " : " << setw(10) <<  double(Nmupt50 )/double(TotalN ) << " Survived in tot" << endl ;
        cout << "@Num of HLT           = " << setw(12) << Ntrigg             << " : " << setw(10) <<  double(Ntrigg  )/double(TotalN ) << " Survived in tot" << endl ;
        cout << "@Num of HighPtExist   = " << setw(12) << NHighPtExist       << " : " << setw(10) <<  double(NHighPtExist   )/double(TotalN) << " Survived in tot" << endl ;
        cout << " Num of HighPt1PassTrk= " << setw(12) << NHighPtPassTrk     << " : " << setw(10) <<  double(NHighPtPassTrk )/double(TotalN) << " Survived in tot" << endl ;
        cout << " Num of HighPt2       = " << setw(12) << NHighPt2           << " : " << setw(10) <<  double(NHighPt2)/double(TotalN) << " Exist in tot" << endl ;
        ...
        cout << "@Num of Muon Selection= " << setw(12) << NMuonSelection     << " : " << setw(10) <<  double(NMuonSelection)/double(TotalN) << " Survived in tot" << endl ;
        cout << " Num of Mt>60GeV      = " << setw(12) << NMt60Cut           << " : " << setw(10) <<  double(NMt60Cut)/double(TotalN) << " Survived in tot" << endl ;
        cout << "@Num of Mt>80 KinCut  = " << setw(12) << MKinCutPass        << " : " << setw(10) <<  double(MKinCutPass)/double(TotalN) << " Survived in tot" << endl ;
